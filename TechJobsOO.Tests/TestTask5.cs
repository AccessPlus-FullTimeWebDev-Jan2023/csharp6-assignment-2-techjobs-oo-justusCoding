...
/*
        ...
        public void Test_TestToString_Starts_And_Ends_With_NewLine()
        {
            ...
            //setup
            string text = System.IO.File.ReadAllText("C:\\Users\\Business\\Desktop\\full_time_unit_2_work\\Csharp_assighnments\\Assighnment_2_repo_TechJobs_OO\\TechJobsOO.Tests\\StartsAndEndsWithNewLine.txt").ToString();
...
*/
 ...
 /*       [TestMethod] //6
        public void Test_TestToStringHandlesEmptyField()
        {
            ...
            string text = System.IO.File.ReadAllText("C:\\Users\\Business\\Desktop\\full_time_unit_2_work\\Csharp_assighnments\\Assighnment_2_repo_TechJobs_OO\\TechJobsOO.Tests\\EmptyFieldTest.txt").ToString();
            var stringWriter = new StringWriter();
            Console.SetOut(stringWriter);
            var job = new RunTechJobs();
            job.RunProgram();
